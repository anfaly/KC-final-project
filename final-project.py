...
gamewindow.geometry("655x600+300+300")
gamewindow.configure(background="gold")

topfram = Frame(
    gamewindow, height=380, bg="brown", bd=15, pady=2, width=790, relief=RIDGE
)
...
quitbutton = Button(
    buttomframe,
    text="خروج",
    command=lambda: quit(gamewindow),
    width=10,
    height=3,
    fg="red",
    bg="silver",
